"""
Django settings for arches76a project.
"""
...
DATATYPE_LOCATIONS.append("arches76a.datatypes")
FUNCTION_LOCATIONS.append("arches76a.functions")
ETL_MODULE_LOCATIONS.append("arches76a.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches76a.search_components")
...
SECRET_KEY = "django-insecure-n-66$os-3m629duaw=cy1y7#$@-+h!@1tjjny8$(d-nq19h5+a"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches76a.urls"
ROOT_HOSTCONF = "arches76a.hosts"

DEFAULT_HOST = "arches76a"
...
ELASTICSEARCH_PREFIX = "arches76a"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches76a.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches76a",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches76a.wsgi.application"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches76a.search.es_mapping_modifier.EsMappingModifier"]
